...
resource "azurerm_resource_group" "WSB-Szymon" {
...
resource "azurerm_storage_account" "azure_account" {
  ...
  resource_group_name      = azurerm_resource_group.WSB-Szymon.name
  location                 = azurerm_resource_group.WSB-Szymon.location
